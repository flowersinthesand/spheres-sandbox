...
/**
 * The SessionBase is provided as an amorphous base interface for the Session interface.
 * <p>
 * The Session interface is a final interface for the application developer to interact a remote
 * endpoint in realtime following the specific protocol.
 * <p>
